...
Slides: [bit.ly/usecomponents](https://sapegin.github.io/slides/inconsistent-styles-full/)<br/> Me: [sapegin.me](http://sapegin.me/)<br/> Twitter: [@iamsapegin](https://twitter.com/iamsapegin)<br/> GitHub: [sapegin](https://github.com/sapegin)
