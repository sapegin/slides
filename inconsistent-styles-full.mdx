...
import Text from './assets/inconsistent-styles-full/code/Text'
...
<Code code={require("!raw-loader!./assets/inconsistent-styles-full/code/Text.js")} />
...
<Code code={require("!raw-loader!./assets/inconsistent-styles-full/code/Box.js")} />
